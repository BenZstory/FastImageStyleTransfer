...
"""
This vgg16.py is mainly borrowed from 
https://github.com/machrisaa/tensorflow-vgg/blob/master/vgg16.py
yet we modified the input scale from [0, 1] to [-1, 1]
"""
...
class Vgg16:
    def __init__(self, vgg16_npy_path=None):
        if vgg16_npy_path is None or vgg16_npy_path == "":
    ...
    def build(self, rgb, include_fc=False):
        ...
        print("layer shape bgr ", bgr.get_shape())

        self.conv1_1 = self.conv_layer(bgr, "conv1_1")
        self.conv1_2 = self.conv_layer(self.conv1_1, "conv1_2")
        self.pool1 = self.max_pool(self.conv1_2, 'pool1')
        # print("layer shape self.pool1 ", self.pool1.get_shape())
        ...
        # print("layer shape pool5 ", self.conv5_3.get_shape())
        self.pool5 = self.max_pool(self.conv5_3, 'pool5')
        # print("layer shape pool5 ", self.pool5.get_shape())
        ...
        # self.style_layers = [self.conv1_1, self.conv2_1, self.conv3_1, self.conv4_1, self.conv5_1]
        # self.content_layers = [self.conv4_2]
